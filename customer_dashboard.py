...
# ✅ Step 4: Display Machines That Need Refilling
...
# ✅ Step 5: Vending Machine Stock Levels
st.subheader("📋 Vending Machine Stock Levels")
st.dataframe(df)

# ✅ Step 6: Refill a Machine
...
# ✅ Step 7: Adjust Refill Threshold
